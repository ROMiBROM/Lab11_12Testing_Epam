...
public class SpotifyTakeInformHome {
    ...
    @FindBy(xpath = "//*[@id=\"context-menu\"]/ul/li[5]/button")
    WebElement buttonChooseInformation;

    @FindBy(xpath = "/html/body/div[16]/div/div/div/div[1]/h1")
    WebElement Information;

    public SpotifyTakeInformHome(WebDriver driver) {
        this.driver = driver;
        PageFactory.initElements(driver, this);
    }
    public boolean TakeInformation(String song)
    {
        ...
        try{
            ...
            waitForElementLocatedBy(driver,buttonChooseInformation );
            buttonChooseInformation.click();
            waitForElementLocatedBy(driver,Information );
            String x=Information.getText();
            if(x.equals("Сведения")) {
                logger.info("Took Information!");
                return true;
            }
            else {
                return false;
